...
Armed with that information I used Wireshark to [sniff the USB bus](http://delog.wordpress.com/2011/08/19/sniff-usb-bus-on-linux/). The USB capture is usually very verbose, I used the filter `usb.data_flag == "present (0)"` to get to the relevant packets.
